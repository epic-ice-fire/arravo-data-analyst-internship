...
This log covers the Week 8 activities completed so far. The SQL used for the analysis is saved in `week8_sales_eda_query_pack.sql`.
...
- `week8_sales_eda_activity_log.md` — Week 8 EDA activity and explain-back log
- `week8_sales_eda_query_pack.sql` — EDA query pack covering revenue, customers, products, seasonality, and discount impact

The query pack contains the 10+ query Week 8 SQL challenge and is ready to be executed against the `arravo_retail` MySQL database.